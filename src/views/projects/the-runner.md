---
imageUrl: "https://via.placeholder.com/300x450?text=The%20Runner"
---
### **Title: Crisis Response Data Wall**

### **Description:**
Reflect the political firestorms of *The Runner* by streaming crisis cards from an API and categorizing their volatility.

### **Features:**
- Fetch multiple records in one click.
- Highlight stable versus volatile statuses.
...
<head>
    ...
    <title>Crisis Response Data Wall</title>
<style>
...
<body>
    <h1>Crisis Response Data Wall</h1>
    <p>Pull scenario data, just like <em>The Runner</em> juggles rapidly changing intel.</p>
