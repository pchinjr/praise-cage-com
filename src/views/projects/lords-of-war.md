---
imageUrl: "https://via.placeholder.com/300x450?text=Lords%20of%20War"
---
### **Title: Arms Route Risk Monitor**

### **Description:**
Track illicit shipments for *Lords of War* with repeated fetch calls that classify which routes are heating up.

### **Features:**
- Pull remote data batches on demand.
- Visualize which runs are safe or hot.
- Handle API failures with clear messaging.
...
<head>
    ...
    <title>Arms Route Risk Monitor</title>
<style>
...
<body>
    <h1>Arms Route Risk Monitor</h1>
    <p>Pull scenario data, just like <em>Lords of War</em> juggles rapidly changing intel.</p>
